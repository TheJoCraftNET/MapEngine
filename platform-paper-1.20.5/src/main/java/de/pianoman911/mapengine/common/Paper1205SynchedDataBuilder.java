...
public final class Paper1205SynchedDataBuilder {
    ...
    private Paper1205SynchedDataBuilder() {
    }

    public static Paper1205SynchedDataBuilder builder() {
        return new Paper1205SynchedDataBuilder();
    }

    public <T> Paper1205SynchedDataBuilder setDataItem(EntityDataAccessor<T> accessor, T defaultValue) {
