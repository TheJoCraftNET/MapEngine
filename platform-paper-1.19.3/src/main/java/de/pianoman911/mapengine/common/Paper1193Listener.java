...
public final class Paper1193Listener extends MessageToMessageDecoder<Packet<?>> implements ServerboundInteractPacket.Handler {
    ...
    public Paper1193Listener(Player player, IListenerBridge bridge) {
        this.player = player;
        this.bridge = bridge;
    }
