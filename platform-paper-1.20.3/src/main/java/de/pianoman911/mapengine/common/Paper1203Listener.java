...
public final class Paper1203Listener extends MessageToMessageDecoder<Packet<?>> implements ServerboundInteractPacket.Handler {
    ...
    public Paper1203Listener(Player player, IListenerBridge bridge) {
        this.player = player;
        this.bridge = bridge;
    }
